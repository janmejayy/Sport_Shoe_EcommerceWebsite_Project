...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	public void init() {
		...
		PurchaseReport pr1 = new PurchaseReport(6,"Janmejay","Running",d,"adidas_runner:5,nike_airmax:10");
		PurchaseReport pr2 = new PurchaseReport(7,"JAY","Cricket",d,"adidas_cricket:5,nike_cricket:10");
		PurchaseReport pr3 = new PurchaseReport(8,"SatyaPrakash","Basketball",d,"adidas_basketball:5,nike_basketball:10");
		PurchaseReport pr4 = new PurchaseReport(9,"Sachin","Football",d,"adidas_football:5,nike_football:10");
		PurchaseReport pr5 = new PurchaseReport(10,"Satyam","Badmintan",d,"adidas_Badmintan:10,nike_Badmintan:10");
